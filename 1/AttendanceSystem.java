...
class Classroom {
    private Student[] students = new Student[10]; // Max capacity 10
    ...
    public void displayStudents() {
        ...
        for (int i = 0; i < studentCount; i++) {
            System.out.printf("%-11d %-10s %-13d\n", students[i].getStudentId(), students[i].getName(), students[i].getDaysAttended());
        }
    }
}
 ...
 class AttendanceSystem {
    public static void main(String[] args) {
        ...
        //classroom.updateAttendance(104, 20); // Non-existent student
